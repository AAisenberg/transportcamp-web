  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="bg-tc-off-white py-14 md:py-20">
          <div className="mx-auto max-w-3xl px-5 md:px-8">
            <FadeIn>
              ...
              <p className="mt-5 font-sans text-lg text-tc-muted leading-relaxed">
                TransportCamp is currently seeking sponsors for 2026 events in
                Sydney and Melbourne. Sponsorship helps cover venue and
                production costs, keeps ticket prices accessible, and supports an
                open format where participants set the agenda.
              </p>
              <p className="mt-4 font-sans text-lg text-tc-muted leading-relaxed">
                Packages are tailored to each event and city. We will publish
                tier details when 2026 partnerships are confirmed — for now, get
                in touch to discuss what would work for your organisation.
              </p>
            </FadeIn>
          </div>
        </section>
